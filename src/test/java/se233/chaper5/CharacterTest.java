...
public class CharacterTest {
    ...
    @Test
    public void characterShouldMoveToTheLeftAfterTheLeftKeyIsPressed() throws IllegalAccessError, InvocationTargetException, NoSuchFieldException, IllegalAccessException {
